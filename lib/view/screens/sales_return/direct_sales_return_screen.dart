...
class DirectSalesReturnScreen extends StatefulWidget {
  const DirectSalesReturnScreen({super.key});

  @override
  State<DirectSalesReturnScreen> createState() =>
      _DirectSalesReturnScreenState();
}

class _DirectSalesReturnScreenState extends State<DirectSalesReturnScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Direct Sales Return"),
      ),
